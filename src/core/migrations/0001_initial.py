...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('file', models.ImageField(upload_to=core.models.set_unique_filename, validators=[core.utils.validators.validate_image_format, core.utils.validators.validate_image_size])),
        ...
        migrations.AddField(
            ...
            name='account_tier',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.accounttier'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='groups',
